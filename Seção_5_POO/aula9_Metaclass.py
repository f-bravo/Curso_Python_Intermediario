...
# EM PYTHON, TUDO É UM OBJETO inclusive classes
# Qual é o tipo de uma classe? (type)
...
class Meta(type):
    ...
    def __call__(cls, *args, **kwargs): # cria a instância e chama o __init__ ()
...
class Pessoa(metaclass=Meta):  # class pessoa é a instância da metaclass
    # falar = 123
