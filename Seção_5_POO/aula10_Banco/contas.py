...
class ContaPoupanca(Conta):
    def sacar(self, valor):
        ...
        if valor_pos_saque >= 0:
            ...
            return self.saldo # se entrar nesse IF para aqui retornando saldo
...
class ContaCorrente(Conta):
    def __init__(
        ...
        super().__init__(agencia, conta, saldo)  # vai p super class Conta
        self.limite = limite                     # vai p conta corrente
